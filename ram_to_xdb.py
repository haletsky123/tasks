...
class RamToXdb:
    ...
    def __generate_tables(self):
        ...
        for table in self.schema.tables:
            ...
            if is_not_empty(table.ht_table_flags):
                current_table.setAttribute('ht_table_flags', str(table.ht_table_flags))

            if is_not_empty(table.access_level):
                current_table.setAttribute('access_level', str(table.access_level))
